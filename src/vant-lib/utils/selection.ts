 ...
 * @returns
 */
export const getTextPrecedingCurrentSelection = (element?: HTMLInputElement, isContentEditable = true) => {
  let text = ''
...
export const getLastWordInText = (text: string, autocompleteSeparator = '') => {
  let wordsArray
...
export const getTriggerInfo = (c: string, requireLeadingSpace: boolean) => {
  ...
  if (effectiveRange !== undefined && effectiveRange !== null) {
    ...
    const idx = requireLeadingSpace ? lastIndexWithLeadingSpace(effectiveRange, c) : effectiveRange.lastIndexOf(c)
